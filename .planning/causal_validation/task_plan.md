...
- **Status:** Stage A has 26 promoted roots: 16 closed roots from v32, the two-state v31 open hard pair, one v34 open root, and seven v35 roots. The grasp-topology diagnosis is complete: the old joint drawer/grasp trace re-seats the bowl by about `20.4 mm`, while phase-separated drawer opening plus registered episode-474 acquisition preserves the strict continuity gate. The frozen v36 construction-only smoke `phase3b_stage_a_construction_gate_20260731T094517Z` passes all six untouched grasped roots, three matched-pair geometry audits, and fresh certificates at common timestep 560 with zero proposal execution. The first incomplete action is the fresh six-root/492-attempt v36 proposal shard, followed by 32-root consolidation and reconstruction/accounting audit. Cross-aperture/source-revision, root-timestep, and cross-oracle-mode effects remain non-estimable; Stages B/C are separate simulation-scope decisions.
