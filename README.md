...
The first incomplete phase is therefore an occupancy-balanced state-lattice gate, not immediate π0.5/GR00T scaling or activation patching. The staged, preregistered proposal is in [`docs/phase3b_methodology.md`](docs/phase3b_methodology.md). No external checkpoint has been downloaded.
